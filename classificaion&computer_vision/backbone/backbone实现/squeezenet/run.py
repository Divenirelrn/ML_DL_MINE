...
tbWriter = tensorboardX.SummaryWriter("./runs/sq_big_lr")
...
#net = vgg16_bn()
net = squeezenet(class_num=2)
net.to(device)
device_ids = [0,1,2,3]
net = DP(net, device_ids = device_ids)
criterion = nn.CrossEntropyLoss()
#optimizer = optim.Adam(net.parameters(), lr=2e-3)
optimizer = optim.SGD(net.parameters(), lr=0.003, momentum=0.9, weight_decay=2e-2)
