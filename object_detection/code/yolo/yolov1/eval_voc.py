...
def map_compute():
    ...
    for image_path in tqdm(image_list):
        result = predict_gpu(model,image_path,root_path='/home/workspace/vocall/') #result[[left_up,right_bottom,class_name,image_path],]
    ...
    map_ = voc_eval(preds,target,VOC_CLASSES=VOC_CLASSES)
