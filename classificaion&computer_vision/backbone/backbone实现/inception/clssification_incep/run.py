...
tbWriter = tensorboardX.SummaryWriter("./runs/inception_resnet_bak")
...
data_test_loader = DataLoader(data_test, batch_size=256, num_workers=16)
...
optimizer = optim.SGD(net.parameters(), lr=0.01, momentum=0.9, weight_decay=3e-2)
