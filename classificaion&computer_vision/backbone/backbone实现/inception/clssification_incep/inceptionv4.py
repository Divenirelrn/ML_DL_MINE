...
class Inception_Stem(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.branch3x3_conv = BasicConv2d(64, 96, kernel_size=3, padding=0, stride=2)
