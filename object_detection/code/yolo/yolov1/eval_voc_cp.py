...
def map_compute():
    ...
    state_dict = torch.load("./weights/best_vgg.pth")
    ...
    for image_path in tqdm(image_list):
        result = predict_gpu(model,image_path,root_path='/home/data/train_places/data/vocall/') #result[[left_up,right_bottom,class_name,image_path],]
